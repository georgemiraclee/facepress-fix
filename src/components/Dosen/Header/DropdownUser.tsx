    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs">{profile.nip || "Memuat..."}</span>
        </span>
      ...
      {/* <!-- Dropdown Start --> */}
       ...
       <div
        ...
        className={`absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark transition-transform duration-200 ease-in-out ${
